...
INSTALLED_APPS = [
    ...
    'rest_framework',  # Déjà présent
    'portfolio',  # Déjà présent
    'corsheaders',  # Ajouté ici (avec une virgule à la fin si nécessaire)
]
...
LANGUAGE_CODE = 'fr-fr'  # Set to French for your portfolio
